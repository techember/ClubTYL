...
export const BottomBanner: React.FC = () => {
  ...
  useEffect(() => {
    fetch(`https://api.clubtyl.techember.in/api/bottom-banner/admin/list`, {
      method: "GET",
      headers: {
  ...
  const handleDelete = (id: string) => {
    fetch(`https://api.clubtyl.techember.in/api/bottom-banner/${id}`, {
      method: "DELETE",
      headers: {
        token: localStorage.getItem("token") || "",
      },
  ...
  const handleUpdate = () => {
    ...
    fetch(`https://api.clubtyl.techember.in/api/bottom-banner/${editBanner._id}`, {
      method: "PUT",
      headers: {
        token: localStorage.getItem("token") || "",
      },
  ...
  const handleSubmit = () => {
    ...
    fetch(`https://api.clubtyl.techember.in/api/bottom-banner/create`, {
      method: "POST",
      body: formData,
      headers: {
        token: localStorage.getItem("token"),
  ...
  return (
    <AdminLayout title="Bottom Banners">
          ...
          <div className="p-6 border-b border-border bg-muted/20">
            <div className="flex items-start sm:items-center justify-between gap-4 flex-col sm:flex-row">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Manage your home screen bottom banners</p>
              </div>
              <button
