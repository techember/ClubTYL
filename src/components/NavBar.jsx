...
export default function NavBar({navigation,data}) {
  ...
  return (
    ...
    <View style={styles.nav}>
      <TouchableOpacity>
      <FeatherIcon name="home" size={30} color={COLORS.purple} /> 
      </TouchableOpacity>
    </View>
    <View style={styles.nav}>
      <TouchableOpacity onPress={()=>{navigation.navigate('Chart',{id:data._id})}}>
      <Icon name="chart-bar" size={30} color={COLORS.purple} /> 
      </TouchableOpacity>
    </View>
    ...
    <View style={styles.nav}>
      <TouchableOpacity onPress={()=>navigation.navigate('PinScreen',{userData:data})}>
      <MaterialIcon name="wallet-outline" size={30} color={COLORS.purple} /> 
      </TouchableOpacity>
    </View>
    <View style={styles.nav}>
